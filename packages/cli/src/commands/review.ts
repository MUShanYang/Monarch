...
import { StateManager, formatLengthCount, readGenreProfile, resolveLengthCountingMode } from "@actalk/monarch-core";
...
function parseBookAndChapter(
  ...
  throw new Error("Usage: monarch review approve [book-id] <chapter>");
}
