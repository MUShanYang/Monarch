export { DnaCompressor, compressDna, createLexicalState, degradeDNA } from "./dna-compressor.js";
export type { LexicalState, DnaCompressorInput, DnaCompressorOutput, DegradationLevel } from "./dna-compressor.js";
